<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id: 2}">
            ...
            <div class="mt-4" x-show="role_id == 2">
                <x-jet-label for="student_College_School" value="{{ __('College_School') }}" />
                <x-jet-input id="student_licence_number" class="block mt-1 w-full" type="text" :value="old('student_licence_number')" name="student_College_School" />
            </div>
